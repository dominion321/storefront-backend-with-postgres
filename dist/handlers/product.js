...
var ProductHandler = /** @class */ (function () {
    ...
    ProductHandler.prototype.destroy = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var product_id, deleted, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, store.destory(product_id)];
                    case 2:
                        deleted = _a.sent();
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Error in deletion ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
